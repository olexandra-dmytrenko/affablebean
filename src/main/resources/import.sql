...
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('63.53', 1, '2015-03-14 00:00:00', 3);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('34.71', 2, '2016-02-08 00:00:00', 3);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('99.48', 3, '2016-03-9 00:00:00', 5);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('278.83', 4, '2015-02-11 00:00:00', 5);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('145.44', 5, '2016-03-28 00:00:00', 1);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('214.04', 6, '2016-01-08 00:00:00', 2);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('210.88', 7, '2015-09-30 00:00:00', 3);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('126.26', 8, '9-11-2015-09-11 00:00:00', 4);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('77.52', 9, '2015-06-29 00:00:00', 3);
insert into customer_order (amount, confirmation_number, date_created, customer_id) values ('63.84', 10, '2015-09-11 00:00:00', 1);
